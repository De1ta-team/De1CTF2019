...
<div class="container" style="margin-top:30px">
    <h3 style="margin-bottom:15px;text-align:left;">Search results about&nbsp;'<?php echo @urldecode($_GET['keyword']); ?>'&nbsp;：</h3>
    <div style="margin-top:50px;"><img src="/img/notfound.png" width="50%" height="50%"></div>
</div>

<script>nav_active('friend');nav_user('<?php echo @$_SESSION['user']; ?>');</script>
        <div>
<div class="container" style="margin-top:30px">
    <h3 style="margin-bottom:15px;">Friend</h3>
    <div style="font-size:16px;">Game is your friend. Win the game to get what you want.</div>
    <iframe src="/media/beats/bin/" width="550" height="960" style="border:none;margin-top:20px"></iframe>
</div>

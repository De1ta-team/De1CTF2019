...
#include <string.h>
#define SIZE 100
//unsigned char flag[101] = "~triangle~is~a~polygon~de1ctf{no~n33d~70~c4lcul473~3v3ry~p47h}with~three~edges~and~three~vertices~~~\0";

unsigned char data[100][100] = {{126},
                                {116, 68},
                                {114, 67, 36},
                                {53, 105, 33, 61},
                                {37, 78, 97, 113, 108},
...
unsigned char max_path[101] = {0};
unsigned char tmp_path[101] = {0};


void inc(unsigned char* num)
{
    int i = 0;
...
void calculate_flag() {
    unsigned char count[102] = {0};
    int i;
    int x, y, sum;
    int max_sum = 0;
    memset(count, 0x30, 102);
    while(count[101-SIZE]=='0'){
        x = 0;
        y = 0;
        sum = 0;
        for(i = 0;i<SIZE;i++){
